...
html = '<div style="column-count: 2; column-gap: 20px; font-size: 0.85em;">\n'
for t, d in terms:
    html += '    <div style="break-inside: avoid; margin-bottom: 12px; background: rgba(255,255,255,0.03); padding: 10px; border-radius: 6px; border-left: 3px solid var(--primary-light);">\n'
    ...
    html += '    </div>\n'
html += '</div>\n'
with open('glosario_temp.txt', 'w', encoding='utf-8') as f:
    f.write(html)
print("Done")
